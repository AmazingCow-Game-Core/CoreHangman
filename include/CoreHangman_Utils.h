...
#define COW_COREHANGMAN_VERSION_MINOR    "3"
#define COW_COREHANGMAN_VERSION_REVISION "1"

#define COW_COREHANGMAN_VERSION       \
    COW_COREHANGMAN_VERSION_MAJOR "." \
    COW_COREHANGMAN_VERSION_MINOR "." \
    COW_COREHANGMAN_VERSION_REVISION
